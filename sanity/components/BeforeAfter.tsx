...
export const BeforeAfter = () => (
  <div className="carousel w-full">
    <div id="slide1" className="carousel-item relative w-full">
      <ReactCompareSlider
        itemOne={<ReactCompareSliderImage src="https://daisyui.com/images/stock/photo-1625726411847-8cbb60cc71e6.jpg" alt="Image one" />}
        itemTwo={<ReactCompareSliderImage src="https://daisyui.com/images/stock/photo-1625726411847-8cbb60cc71e6.jpg" alt="Image two" />}
      />
