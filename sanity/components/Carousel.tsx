...
<div className="flex flex-col items-center w-full">
  <div className="carousel w-full h-[80vh]">
    <div id="item1" className="carousel-item w-full">
      <Hero image={"https://images.unsplash.com/photo-1527581849771-416a9d62308e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"} descriptions={''} title={''} />
    </div>
